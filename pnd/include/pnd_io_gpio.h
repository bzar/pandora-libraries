...
int PND_Pad_RecentlyPressed(enum pnd_keytype_e num); // after SendKeyEvents is done, call this to check a given key(assuming you're not just using ioctl EVIOCGKEY or SDL joy/keyb to do it)
