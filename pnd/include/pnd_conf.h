...
#define PND_CONF_BADNUM (-31337)/* really lame hack, I know */
    ...
    struct pnd_conf_filename_t
    {
        enum pnd_conf_filename_e id;
        char *filename;
    };

    extern struct pnd_conf_filename_t pnd_conf_filenames[];
     ...
     */
    pnd_conf_handle pnd_conf_fetch_by_id(enum pnd_conf_filename_e id, char *searchpath);
