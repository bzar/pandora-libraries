...
void pnd_disco_destroy(struct pnd_disco_t *p)
{
...
static int pnd_disco_callback(const char *fpath, const struct stat *sb __attribute__((unused)),
                              int typeflag, struct FTW *ftwbuf)
{
    ...
    if (pxmlh)
    {
        ...
        {
            struct pnd_disco_t *p;
            char *fixpxml;
            char *z;

            p = pnd_box_allocinsert(disco_box, (char*)fpath, sizeof(struct pnd_disco_t));
